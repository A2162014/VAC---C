//VAC - C - Mini Project
/*Task 3: Write a program to display a menu to the passenger usingswitch
case for the following - 1. Company details 2.Candidate details 3. Score
details.*/
...
int main() {
    char company_cin[20], company_name[20], company_roc[20], company_category[20], company_subcategory[20], company_class[10], company_doi[10], company_address[100], company_status[20];
    char candidate_name[50], candidate_gender[10], candidate_post_applied[50], candidate_degree[50], grade;
    unsigned short op, candidate_age, mark_grade_point = 4, round1_score, round2_score, round3_score;
